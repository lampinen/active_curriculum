...
total_training_set_size = 10000 # <= 55000, restrict data set size to make problem harder
...
numpy.savetxt('s_scores.csv',s_scores,delimiter=',')
numpy.savetxt('c_scores.csv',c_scores,delimiter=',')
numpy.savetxt('ac_scores.csv',ac_scores,delimiter=',')
