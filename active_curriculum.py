...
for seed in xrange(naveragingtrials):
	...
	return error,standard_error,active_error,active2_error
...
print("Mean error rates (std. dev.): active curriculum = %f (%f), active2 curriculum = %f (%f), curriculum = %f (%f), non-curriculum = %f (%f)" %(numpy.mean(active_error_track),numpy.std(active_error_track),numpy.mean(active2_error_track),numpy.std(active2_error_track),numpy.mean(error_track),numpy.std(error_track),numpy.mean(standard_error_track),numpy.std(error_track)))

plot.hist([standard_error_track,error_track,active_error_track,active2_error_track],histtype='bar')
plot.title("Error rates")
plot.legend(['Non-Curr.','Curr.','Act. Curr.','Act2. Curr.'])
plot.show()


plot.hist([standard_dot_track,dot_track,active_dot_track,active2_dot_track],histtype='bar')
plot.title("Weight dot products")
plot.legend(['Non-Curr.','Curr.','Act. Curr.','Act2. Curr.'])
plot.show()
