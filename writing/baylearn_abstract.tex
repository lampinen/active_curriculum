...
\item Proceed from one chunk to the next once the running average accuracy on the last $n$ training examples is below some threshold. (Optional: randomly incorporate examples from other chunks at a low rate to reduce overfitting)%% cf. \cite{Zaremba2014}
